pub const EntityTypeFactory = @import("entity_id.zig").EntityTypeFactory;
pub const EntityOptions = @import("entity_id.zig").EntityOptions;
pub const EntityLocation = @import("entity_location.zig").EntityLocation;
